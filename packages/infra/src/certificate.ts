...
/**
 * Generates a tamper-evident certificate for an analysis result.
 *
 * The preimage binds a one-way hash of the subject to the verdict,
 * the number of findings, and the timestamp, so a verdict can be
